 ...
 *\params ns The name service object.
 *\param broadcast_timeout Do a broadcast every timeout seconds
 *\param callbacks The callbacks previously setup by the caller
